...
namespace PacketSniffer
{
    public class DNSHeader
    {
        ...
        private ushort usTotalQuestions;        //Sixteen bits indicating the number of entries in the questions list
        private ushort usTotalAnswerRRs;        //Sixteen bits indicating the number of entries, entries in the answer resource record list
        private ushort usTotalAuthorityRRs;     //Sixteen bits indicating the number of entries, entries in the authority resource record list
        private ushort usTotalAdditionalRRs;    //Sixteen bits indicating the number of entries, entries in the additional resource record list                               
